...
| 突合の方法 | 本ディレクトリの [`crosswalk-method.md`](crosswalk-method.md) | 判定の記号、突合前の統合、限界、⏳ の行き先 |
...
⚠️ **突合のやり方は [`crosswalk-method.md`](crosswalk-method.md) にある。**
判定の記号（✅ 🔨 🆕 ⏳）、突合前の統合、限界、⏳ の行き先を定める。
