...
- 現在の進捗: 第3段階の第1バッチ（REQ-C01〜REQ-C05）を選択・記録済み。第2バッチは未提示
- 版: v0.5（第1バッチの選択結果と理由を記録）
...
| 第3段階 | 要求項目ごとの5択 | 進行中（第1バッチ完了・5/9件選択済み） |
| 第4段階 | 要件定義変更案の作成 | 未着手 |
...
第1バッチは5件すべて選択済みである。次に、第2バッチの `REQ-C06`〜`REQ-C09` を
同じディレクトリへ追加する。
