...
- 版: **v0.3**（工程モデルの確定とサブ要求2件の追加）
- 前版: v0.2.1（工程モデルの確定）／ v0.2（選択済み要求の統合完了）／ v0.2-draft（骨組み更新）／ v0.1（初版・ドラフト）
...
| サブ要求 | `REQ-C03-S01` ほか | 14 | メイン要求を具体化する一次識別子 |
...
>
> ⚠️ **利用者の熟達段階の保持（`ARF-M-12`）は本選択に含まない。** Scope の結果を蓄積するかは別途判断する。
