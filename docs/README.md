...
| [`requirements-decisions/batch-06-options.md`](requirements-decisions/batch-06-options.md) | **利用者の状態の第6バッチ**。専門分野・既読資料・熟達段階をどこまで横断保持するかの5択。**17エンティティに利用者を表すものが無い点と、熟達段階の推定が既存方針と衝突しうる点を明記**。選択待ち |
