...
5. 依頼に該当する場合だけ、`paper-repro-arch-guide`、`arxiv-paper-repro`、
   `paper-repro-devlog`、`paper-repro-commit-output`、`paper-repro-delegate-integration`、`paper-repro-requirement-deferral`、`paper-repro-upstream-isolation`の正本を全文読む。
